...
public class MainPlayerCamera : MonoSingleton<MainPlayerCamera>
{
    ...
    private void LateUpdate()
    {
       ...
       this.transform.position =
           Vector3.Lerp(this.transform.position, player.transform.position, Time.deltaTime * followSpped);
       ...
       {
           this.transform.rotation = Quaternion.Lerp(this.transform.rotation, player.transform.rotation * yaw,
               Time.deltaTime * followSpped);
       }

       if (Input.GetAxis("Vertical")>0.01)
       {
           yaw = Quaternion.Lerp(yaw, Quaternion.identity, Time.deltaTime * followSpped);
       }
    }
}
